...
public class NhanKhauService {
    ...
    public void themKhaiTu(KhaiTuModel khaiTuModel) {
        try {
            ...
            String query = "INSERT INTO khai_tu  "
            		+ "VALUES (?,?,?,?,?,?,?);";   
            PreparedStatement preparedStatement = connection.prepareStatement(query, Statement.RETURN_GENERATED_KEYS);
	        preparedStatement.setInt(1, ID);
	        preparedStatement.setString(2,soGiayKhaiTu );
	        preparedStatement.setString(3, soCMTnguoiKhai);
	        preparedStatement.setString(4,soCMTnguoiChet);
	        preparedStatement.setString(5,ngayKhai );
	        preparedStatement.setString(6, ngayMat);
	        preparedStatement.setString(7,lyDoChet );
